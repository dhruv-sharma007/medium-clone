...
const ProfileSection = ({ author }: { author: IGetProfileResponse | undefined }) => {
            ...
            <main className="pt-20 w-full max-w-5xl mx-auto px-4">
                ...
                <section className="flex flex-col md:flex-row md:justify-between items-center gap-6 py-6 border-b">
                    ...
                    <div className="flex flex-col md:items-end w-full md:w-auto gap-4">
                        <ProfileStat followers={author?.followers} following={author?.following} posts={author?.postCount} />
                                ...
                                <div className='flex gap-3'>
                                    {author?.isUserFollowing ?
                                        <>
                                            ...
                                            <button className="btn btn-dash btn-sm rounded-lg" onClick={onUnFollow} >UNFOLLOW</button>
                                        </>
                                        :
                                        <>
                                            <button className="btn btn-info btn-sm rounded-lg" onClick={onFollow} >
                                                {author?.isFollowedByAuthor ? <>FOLLOW BACK</> : <>FOLLOW</>}
                                            </button>
                                    ...
                                    <button className="btn btn-info btn-sm rounded-lg">Chat</button>
                                </div>
