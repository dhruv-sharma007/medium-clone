...
const UploadPost = () => {
    const defaultImage = 'https://www.eligocs.com/_next/static/media/empty.828db9a9.jpg'
    ...
    return (
        <form onSubmit={onSubmit} className='mt-16 p-4 h-[92vh] flex justify-center items-center bg-gray-50'>
